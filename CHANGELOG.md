...
* add version update notifications ([92eb84d](https://github.com/maxgfr/csv-ai-analyzer/commit/92eb84d687998625d06cc5e26d66b9d9bc5f38e1))
...
* preserve API keys when toggling custom endpoints ([3ecdf12](https://github.com/maxgfr/csv-ai-analyzer/commit/3ecdf1278ee2f3f7603621d427f14784f5c04139))
...
* restore pnpm workspace symlink and add API key env vars in Docker ([d40e813](https://github.com/maxgfr/csv-ai-analyzer/commit/d40e813361d6fdfe198457b2c85fbe918ce1f5a5))

# [1.14.0](https://github.com/maxgfr/csv-ai-analyzer/compare/v1.13.0...v1.14.0) (2026-03-26)


### Features

* Fix SVG export rendering and improve PDF pagination ([d0326ff](https://github.com/maxgfr/csv-ai-analyzer/commit/d0326ff2d7c8e545e6c2592a3914751e8073ff9f))
...
* Switch chart export from PNG to SVG ([e511f9b](https://github.com/maxgfr/csv-ai-analyzer/commit/e511f9b28f5ec4f6d953cb032894238b3bb6c109))
...
* Improve SVG export reliability and resource cleanup ([78d881f](https://github.com/maxgfr/csv-ai-analyzer/commit/78d881fc5a50acfd0f47d4b35022c202b98a2e09))
...
* add content-based matching mode to CSVCompare ([7941d8e](https://github.com/maxgfr/csv-ai-analyzer/commit/7941d8e021ac6cd83b8415f71db517fcf001a4df))
...
* fullscreen layout fills screen for all components and fix CSVCompare diff table ([851cc84](https://github.com/maxgfr/csv-ai-analyzer/commit/851cc84e4bab8edaa241e07cbbec3a7fb14b2914))
